...
async def chat(request: Request, payload: ChatRequest, background_tasks: BackgroundTasks):
    ...
    try:
        ...
        # Persist after the response is sent -- a slow/unreachable MongoDB
        # should never delay the answer the user is waiting on.
        background_tasks.add_task(save_to_mongo, session_id, message, answer)
